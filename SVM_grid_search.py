...
model_path = "./pipeline_saved_processes/models/SVM_nystroem_grid.pkl"
conf_matrix_path = "pipeline_outputs/SVM/SVM_nystroem_grid.png"
...
if not os.path.isfile(model_path):
    ...
    X_train, X_test, y_train, y_test = video_train_test_split(X, y, 5, 42)
    ...
    grid.fit(X_train, y_train_ravel, groups = X_train.index.get_level_values("video_id"))
