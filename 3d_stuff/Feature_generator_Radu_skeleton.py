...
coll["skele"].data.iloc[:0] ##dumps all data
coll["skele"].data.index = ["nose_earl", "nose_earr", "neck_earl", "neck_earr", "neck_bcl", "neck_bcr", "bcl_hipl", "bcr_hipr", "hipl_tailbase", "hipr_tailbase"] ##this is incomplete
