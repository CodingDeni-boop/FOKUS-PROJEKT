...
#QWEBBIN: how do we iterate over a feature collection with this? what do we feed in?
def seg_angle(
        data, point1: str, point2: str, point3: str, point4: str
) -> FeaturesResult:
    ...
    meta = {"function": "seg_angle", "point1": point1, "point2": point2, "point3": point3, "point4": point4}
    return FeaturesResult(angle, name, meta)